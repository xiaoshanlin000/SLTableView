...
public class TimePopupWindow extends PopupWindow implements OnClickListener {
    ...
    public TimePopupWindow(final Activity context, Type type) {
        super(context);
        ...
        this.setAnimationStyle(R.style.timepopwindow_anim_style);    this.setOnDismissListener(new OnDismissListener() {
            @Override
